    ...
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          />
          <div className="fixed inset-x-0 bottom-0 sm:absolute sm:right-0 sm:top-full sm:mt-2 sm:left-auto z-50 w-full sm:w-96 animate-slide-up sm:animate-fade-in">
